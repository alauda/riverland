package com.alauda.ms.riverland.robwin.service;
...
import com.alauda.ms.riverland.robwin.exception.BusinessException;
...
public class BackendAService implements Service {
    ...
    private static final Logger log = LoggerFactory.getLogger(BackendAService.class);
    private AtomicInteger count = new AtomicInteger();
    //@Autowired
    //ateLimiterRegistry rateLimiterRegistry;
    ...
    public String success() {
        //io.github.resilience4j.ratelimiter.RateLimiter rateLimiter = rateLimiterRegistry.rateLimiter(BACKEND_A);
    ...
    private Mono<String> processFallback(Throwable exc) {
        ...
        return Mono.just("inside from fallback method because `${exc.localizedMessage}`");
    }
}
