package com.alauda.ms.riverland.robwin;

import com.alauda.ms.riverland.RiverlandApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
        classes = RiverlandApplication.class)
public abstract class AbstractIntegrationTest {
    ...
    protected void transitionToClosedState(String circuitBreakerName) {
        CircuitBreaker circuitBreaker = circuitBreakerRegistry.circuitBreaker(circuitBreakerName);
        if(circuitBreaker.getState().equals(CircuitBreaker.State.CLOSED)) return;
